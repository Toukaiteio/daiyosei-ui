  ...
  build: {
    lib: {
      entry: {
        ...
        'components/DialKnob': resolve(__dirname, 'src/components/DialKnob/index.ts'),
        'components/Slider': resolve(__dirname, 'src/components/Slider/index.ts'),
        'components/AvatarPicker': resolve(__dirname, 'src/components/AvatarPicker/index.ts'),
        'components/Breadcrumb': resolve(__dirname, 'src/components/Breadcrumb/index.ts'),
